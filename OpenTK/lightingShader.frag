...
layout (location = 23) uniform vec3 objectColor; //The color of the object.
layout (location = 24) uniform vec3 lightColor; //The color of the light.
layout (location = 25) uniform vec3 lightPos; //The position of the light.
layout (location = 26) uniform vec3 viewPos; //The position of the view and/or of the player.
